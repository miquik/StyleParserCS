...
namespace StyleParserCS.unbescape
{
    ...
    /// 
    /// </summary>
    public sealed class CssIdentifierEscapeLevel : SmartEnum<CssIdentifierEscapeLevel>
    {

        /// <summary>
        /// Level 1 escape: escape only the basic escape set: Backslash Escape plus non-displayable control chars.
        /// </summary>
        public static readonly CssIdentifierEscapeLevel LEVEL_1_BASIC_ESCAPE_SET = new CssIdentifierEscapeLevel("LEVEL_1_BASIC_ESCAPE_SET", 1);

        /// <summary>
        /// Level 2 escape: escape the basic escape set plus all non-ASCII characters (result will always be ASCII).
        /// </summary>
        public static readonly CssIdentifierEscapeLevel LEVEL_2_ALL_NON_ASCII_PLUS_BASIC_ESCAPE_SET = new CssIdentifierEscapeLevel("LEVEL_2_ALL_NON_ASCII_PLUS_BASIC_ESCAPE_SET", 2);
        ...
        /// </summary>
        public static readonly CssIdentifierEscapeLevel LEVEL_3_ALL_NON_ALPHANUMERIC = new CssIdentifierEscapeLevel("LEVEL_3_ALL_NON_ALPHANUMERIC", 3);

        /// <summary>
        /// Level 4 escape: escape all characters, including alphanumeric.
        /// </summary>
        public static readonly CssIdentifierEscapeLevel LEVEL_4_ALL_CHARACTERS = new CssIdentifierEscapeLevel("LEVEL_4_ALL_CHARACTERS", 4);
        ...
        /// <returns> the escape level enum constant, or <tt>IllegalArgumentException</tt> if level does not exist. </returns>
        //ORIGINAL LINE: public static CssIdentifierEscapeLevel forLevel(final int level)
        public static CssIdentifierEscapeLevel ForLevel(int level)
        {
            switch (level)
            {
                ...
                default:
                    throw new System.ArgumentException("No escape level enum constant defined for level: " + level);
            }
        }


        //ORIGINAL LINE: CssIdentifierEscapeLevel(final int escapeLevel)
        internal CssIdentifierEscapeLevel(string name,  int escapeLevel) : base(name, escapeLevel)
        {
        }
        ...
        /// </summary>
        /// <returns> the escape level. </returns>
