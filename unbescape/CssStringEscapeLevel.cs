...
namespace StyleParserCS.unbescape
{
    ...
    /// 
    /// </summary>
    public sealed class CssStringEscapeLevel : SmartEnum<CssStringEscapeLevel>
    {

        /// <summary>
        /// Level 1 escape: escape only the basic escape set: Backslash Escape plus non-displayable control chars.
        /// </summary>
        public static readonly CssStringEscapeLevel LEVEL_1_BASIC_ESCAPE_SET = new CssStringEscapeLevel("LEVEL_1_BASIC_ESCAPE_SET", 1);

        /// <summary>
        /// Level 2 escape: escape the basic escape set plus all non-ASCII characters (result will always be ASCII).
        /// </summary>
        public static readonly CssStringEscapeLevel LEVEL_2_ALL_NON_ASCII_PLUS_BASIC_ESCAPE_SET = new CssStringEscapeLevel("LEVEL_2_ALL_NON_ASCII_PLUS_BASIC_ESCAPE_SET", 2);
        ...
        /// </summary>
        public static readonly CssStringEscapeLevel LEVEL_3_ALL_NON_ALPHANUMERIC = new CssStringEscapeLevel("LEVEL_3_ALL_NON_ALPHANUMERIC", 3);

        /// <summary>
        /// Level 4 escape: escape all characters, including alphanumeric.
        /// </summary>
        public static readonly CssStringEscapeLevel LEVEL_4_ALL_CHARACTERS = new CssStringEscapeLevel("LEVEL_4_ALL_CHARACTERS", 4);
        ...
        //ORIGINAL LINE: public static CssStringEscapeLevel forLevel(final int level)
        ...
        //ORIGINAL LINE: CssStringEscapeLevel(final int escapeLevel)
        internal CssStringEscapeLevel(string name, int escapeLevel) : base(name, escapeLevel)
        {
        }
