...
namespace StyleParserCS.csskit
{
    ...
    /// @author burgetr
    /// </summary>
    public class ElementMatcherSafeCI : ElementMatcher
    {
        ...
        public virtual bool matchesClass(IElement e, string className)
        {
            if (e.HasAttribute(CLASS_ATTR))
            {
                string classNames = getAttribute(e, CLASS_ATTR).ToLower();
        ...
        {
            return id.Equals(elementID(e), StringComparison.OrdinalIgnoreCase);
        }
        ...
        public virtual bool matchesAttribute(IElement e, string name, string value, Selector_Operator o)
        {
